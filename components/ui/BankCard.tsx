        ...
        <div className="bank-card_content">
          ...
          <article className="flex flex-col gap-2">
            <div className="flex justify-between">
              ...
              <h2 className="text-12 font-semibold text-white">{displayDate}</h2>
            </div>
            <p className="text-14 font-semibold tracking-[1.1px] text-white">{displayNumber}<span className="text-16">{account.mask || '1234'}</span></p>
          </article>
        </div>
